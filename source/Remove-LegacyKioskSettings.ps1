...
If ($AutologonUserName) {
    ...
    If ($UserSession) {
        Write-Log -EventLog $EventLog -EventSource $EventSource -EventId 51 -EntryType Information -Message "User '$AutologonUserName' is currently logged in. Logging off user to prepare for Assigned Access autologon."
